...
def develop(root_dir, coverage_file_name_txt, coverage_file_name_json):
    ...
    print(f"Current Testing Coverage for develop branch is: {curcov_percentage_ftdt}%")
...
def branch(root_dir, coverage_file_name_txt, coverage_file_name_json):
    ...
    print(f"Current Testing Coverage for current branch is: {curcov_percentage_ftdt}%")
    print(f"Current Testing Coverage for develop branch is: {prevcov_percentage_ftdt}%")
...
def main():
    ...
    parser = argparse.ArgumentParser(description='decide whether to extract coverage for develop or a peripheral branch')
    parser.add_argument('function',
                        choices=['develop', 'branch'],
                        help='choose develop or branch')
    parser.add_argument('--txt', dest='coverage_file_name_txt', default='develop_percent_coverage.txt',
                        help='Name of the txt file to store the coverage percentage')
    parser.add_argument('--json', dest='coverage_file_name_json', default='coverage.json',
