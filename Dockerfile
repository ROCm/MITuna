...
ARG MIOPEN_USE_MLIR=Off
ARG MIOPEN_USE_COMPOSABLEKERNEL=On
ARG MIOPEN_CMAKE_ARGS="-DMIOPEN_USE_MLIR=${MIOPEN_USE_MLIR} -DMIOPEN_USE_COMPOSABLEKERNEL=${MIOPEN_USE_COMPOSABLEKERNEL} -DMIOPEN_INSTALL_CXX_HEADERS=On -DMIOPEN_CACHE_DIR=${MIOPEN_CACHE_DIR} -DMIOPEN_USER_DB_PATH=${MIOPEN_USER_DB_PATH} -DMIOPEN_BACKEND=${BACKEND} -DCMAKE_PREFIX_PATH=${MIOPEN_DEPS}"
#-DMIOPEN_USE_HIPRTC=Off -DMIOPEN_USE_COMGR=Off -DUSE_FIN=Off
