...
def solverAnalyticsTest(){
    ...
    tuna_docker.inside("--network host  --dns 8.8.8.8") {
        ...
        sh "python3 ${env.WORKSPACE}/SolverAnalytics/tests/clean_finddb_test.py"
        sh "python3 ${env.WORKSPACE}/SolverAnalytics/tests/cli_test.py"
        sh "python3 ${env.WORKSPACE}/SolverAnalytics/tests/generate_analytics_test.py"
        sh "python3 ${env.WORKSPACE}/SolverAnalytics/tests/gen_finddb_test.py"
        sh "python3 ${env.WORKSPACE}/SolverAnalytics/tests/utils_tests/df_tools_test.py"
        sh "python3 ${env.WORKSPACE}/SolverAnalytics/tests/utils_tests/fdb_key_utils_test.py"
        sh "python3 ${env.WORKSPACE}/SolverAnalytics/tests/utils_tests/helpers_test.py"
        sh "python3 ${env.WORKSPACE}/SolverAnalytics/tests/utils_tests/logging_test.py"
    }
}
